...
(function () {
  class SACInAppFeedback extends HTMLElement {
    constructor() {
      super();
      this.projectId = ""; // Initialize projectId property
    }
    connectedCallback() {
      this.innerHTML = `
  ...
  #QSIFeedbackButton-target-container {
    ...
    // New method to set Project ID
    setProjectId(projectId) {
      this.projectId = projectId;
    }
  }

  customElements.define("sac-in-app-feedback-2", SACInAppFeedback);
})();
...
(function () {
  var g = function (e, h, f, g) {
    this.projectId = f; // Store the projectId in the constructor
    ...
    this.go = function () {
      if (this.check()) {
        ...
        a.src = this.projectId; // Use the dynamic projectId
